...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniGPT SFT")
    parser.add_argument("--data_path", type=str, default="../dataset/sft_mini_512.jsonl", help="监督微调数据路径")
    parser.add_argument("--from_weight", type=str, default="../checkpoints/pretrain_768_16.pth",  help="基于某个权重微调")
